...
export default function PrimarySearchAppBar() {
  ...
  const renderMenu = (
    ...
    >
      {
        isTeacherOrAdmin ? <></> : <MenuItem onClick={handleGotoEnrollments}>Enrollments</MenuItem>
      }
      {
    ...
    <div className={classes.grow}>
      <AppBar
        ...
        <Toolbar>
          ...
          <React.Fragment>
            {
              isTeacherOrAdmin ? <></> : <CustomPrimaryContainedButton
            ...
            {
              isTeacherOrAdmin ? <></> : <CascadingMenu
